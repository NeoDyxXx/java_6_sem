...
public class Sss extends HttpServlet implements Servlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String uri = "http://localhost:8080/lab13/Ggg?firstname=" + firstName + "&lastname=" + lastName
        ...
        if (action.equals("redefine")) {
            ...
            response.sendRedirect("http://localhost:8080/lab13/Ggg?firstname=" + firstName + "&lastname=" + lastName
                    + "&destination=" + redirectDest);
